...
{{% blocks/cover title="Fonctionnalités de lecture différée sur tous vos appareils" color="primary" image_anchor="bottom" height="auto" %}}
...
## Applications Android et iOS avec lecture hors-ligne
...
{{< image80 src="ios.png" alt="Application iOS pour wallabag." >}}

## Extensions navigateur pour sauvegarder en un clic
...
{{% blocks/section color="white" %}}
## Et bien plus de fonctionnalités wallabag.it
